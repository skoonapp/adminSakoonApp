...
const Header: React.FC = () => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 h-14 bg-gradient-to-r from-cyan-600 to-teal-500 dark:from-slate-900 dark:to-slate-800 shadow-md text-white z-50 flex items-center justify-between px-4">
            <h1 className="text-xl font-bold tracking-tight text-white">SakoonApp Admin</h1>
