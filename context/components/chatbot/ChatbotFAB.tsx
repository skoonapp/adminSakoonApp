...
const ChatbotFAB: React.FC<ChatbotFABProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-20 right-4 z-40 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-white shadow-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 transform hover:scale-110 transition-all duration-200"
