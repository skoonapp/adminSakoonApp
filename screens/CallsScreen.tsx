...
const FilterButton: React.FC<{
  ...
  onChange: (e: React.ChangeEvent<HTMLSelectElement>) => void;
    ...
    <select 
        value={value} 
        onChange={onChange}
        className="bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-md shadow-sm py-2 px-3 text-sm font-medium text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500"
    >
        {options.map(option => (
